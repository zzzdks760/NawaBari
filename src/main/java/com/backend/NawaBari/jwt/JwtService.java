...
/*    public void sendAccessToken(HttpServletResponse response, String accessToken) {
     ...
     */
    public void sendAccessAndRefreshToken(HttpServletResponse response, String accessToken, String refreshToken, Long id) {
        response.setStatus(HttpServletResponse.SC_OK);
    ...
    public Optional<String> extractAccessToken(HttpServletRequest request) {
        String access = request.getHeader(accessHeader);
        System.out.println("Authorization Header: " + access);
    ...
    public void updateRefreshToken(String email, String refreshToken) {
        ...
        if (memberOptional.isPresent()) {
            ...
            throw new RuntimeException("일치하는회원이 없습니다.");
        }
    }
